...
class ArticleCommentServiceTest {
    ...
    void givenArticledId_whenSearchingComments_thenReturnsComments(){
        ...
        assertThat(actual).hasSize(1)
                ...
                // hasFieldOrPropertyWithValue 첫번째 값의 content = expected에서 가져온 content이다.
    ...
    void givenArticleCommentId_whenDeletingArticleComment_thenDeletesArticleComment(){
        ...
        //Then
        then(articleCommentRepository).should().deleteById(articleCommentId);//delete를 호출했는지 확인한다.
    }

    //반복되서 사용되는 데이터 형식을 모아둠 -----
